...
tldr_render() {
  ...
  /^>/ {
    ...
    /^> (Aliases|See also|More information|Help|Version|Internal|Deprecated):/! s/^> (.*)$/\\\\e[${SUMMARY_DESCRIPTION_PREFIX_COLOR}m$SUMMARY_DESCRIPTION_PREFIX\\\\e[${SUMMARY_DESCRIPTION_SUFFIX_COLOR}m\1\\\\e[0m/
  }
